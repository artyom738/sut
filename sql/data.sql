...
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (1, 'Lake', 'Omnis velit porro repellendus autem soluta. Quo nihil enim et. Maiores quo qui facilis dolorem et iste sequi. Facere sit repellendus et quas unde.', 464358, 1);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (2, 'North', 'Sapiente rerum optio quo exercitationem temporibus fugit ex. Beatae sunt culpa veritatis at accusamus enim. Sit quam enim qui saepe nobis. Autem at cumque molestias officiis.', 2637918, 2);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (3, 'East', 'Facere delectus corporis qui nisi dolor suscipit. Illum dolorum reprehenderit est quidem omnis. Nobis consequatur qui incidunt qui sed soluta. Quasi blanditiis doloribus ipsum eum qui qui quo.', 1918325, 3);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (4, 'New', 'Voluptate perferendis libero fugiat placeat. Voluptates optio numquam nobis optio. Quae ex voluptatem sed iste.', 4604342, 4);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (5, 'South', 'Assumenda in aut ut autem sequi et sit. Sit non reiciendis quasi quisquam. Error neque ullam vel molestiae tempore.', 4029860, 1);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (6, 'New', 'Provident sit quo aut sed officia id. Magni voluptatibus animi vitae vero. Consectetur enim excepturi nostrum ut enim nihil.', 2603666, 2);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (7, 'East', 'Quos non aperiam id officia nam tenetur velit. Illo quos nihil nesciunt beatae quidem dolor. Magni laborum illum ea cupiditate.', 2758769, 3);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (8, 'West', 'Ut sunt doloribus dolore iusto dolore rerum exercitationem voluptatum. Illum quibusdam cupiditate natus alias. Quos dolorem quis ab officiis inventore iure iure. Cum dolorum ullam suscipit ea dolorem ut dicta.', 3740974, 4);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (9, 'New', 'Voluptatibus numquam vel magni laudantium accusantium provident qui. Eum nemo neque repellendus. Quae qui quia quaerat voluptas illum voluptas earum. Voluptate accusantium odit similique voluptatibus.', 4743514, 1);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (10, 'East', 'Mollitia neque quasi quo fugiat ut. Maxime non at consequatur velit voluptas. Voluptatem non in corrupti quasi.', 1223711, 2);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (11, 'Port', 'Et distinctio beatae rem voluptatem sunt adipisci enim nihil. Qui eius neque repellendus et et reprehenderit voluptates. Quas ab eos perferendis deserunt qui sequi. Vel et animi vitae aut neque. Voluptas in accusantium hic harum delectus saepe rerum.', 4324759, 3);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (12, 'Lake', 'Exercitationem qui magnam eum optio dolor aliquid. Laboriosam et et nemo maxime aperiam corrupti sit quam. Id voluptas nam consequatur corrupti autem modi.', 1509150, 4);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (13, 'North', 'Laudantium ut dolor molestias. Deserunt dicta quos possimus quod necessitatibus. Consequatur alias aliquid illo rerum aut. Quo libero quis dolor quasi.', 1500481, 1);
INSERT INTO `s_city` (`ID`, `NAME`, `DESCRIPTION`, `POPULATION`, `REGION_ID`) VALUES (14, 'Lake', 'Quis ut ut quis maiores minima. Adipisci laborum eum fugiat alias.', 123660, 2);
